        ...
        try {
            ...
            for (let i = 0; i < numberOfRecords; i++) {
                results.push({
                    ...
                    latitude: getRandomInRange(direction.lat, direction.lng, 3),
                    longitude: getRandomInRange(direction.lat, direction.lng, 3),
                    ...
                    caseOccupation: {
                        ...
                        employerEmirate: req.body.occupationDetails.employerEmirate ?
                            req.body.occupationDetails.employerEmirate : 'Dubai',
                        latitude: getRandomInRange(employerDirection.lat, employerDirection.lng, 3),
                        longitude: getRandomInRange(employerDirection.lat, employerDirection.lng, 3),
                    }
                })
